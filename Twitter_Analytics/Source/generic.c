...
/*    printf("\n\nSize of arr4[0] = %lu\n",sizeof(arr4[0]));
    ...
    printf("Size of strlen = %lu\n",strlen(arr4[0]));
    printf("\n%lu sizeofchar64\n",sizeof(char*)*64); teste multiplicando por valor
    */

    int n = 1;
    printf("\n\n\n Array\n\n");
    printf("Testa o %d  elemento do array\n%s\n", n, arr4[n]);
    genericNode *teste; 
//    teste->data = arr4[0];
//    printf("Printstring teste->data = ");
//    printString(teste->data);

    printf("\n\nCreater string linked list is \n");
    for (int i = 0; i >= 0; i--) push(&start, arr4[i],sizeof(char*) * strlen(arr4[i]) + 1);
    printf("\nprintList\n");
